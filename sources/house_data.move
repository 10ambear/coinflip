/// The first module is house_data.move. You need to store the game’s data somewhere, 
/// and in this module you create a shared object for all house data.
module coinflip::house_data {
